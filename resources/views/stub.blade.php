    ...
    <body>
        <div class="ps">
            <div class="ps-header">
                ...
                <div class="ps-info">
                    {{-- <div class="ps-brand"><img src="./spei_brand.png" alt="Banorte"></div> --}}
                    <div class="ps-amount">
                        <h3>Monto a pagar</h3>
                        <h2>$ {{ money_format('%n', $charge->amount / 100) }} <sup>{{ $charge->currency }}</sup></h2>
                        <p>Utiliza exactamente esta cantidad al realizar el pago.</p>
                        {{-- <p>Pagar antes de: {{ Carbon\Carbon::parse('expires_at')->format('d-m-Y') }}</p> --}}
                    </div>
                </div>
            ...
            <div class="ps-instructions">
                ...
                <ol>
                    ...
                    <li>Da de alta la CLABE en esta ficha. <strong>El banco deberá de ser {{ $charge->payment_method->receiving_account_bank }}</strong>.</li>
                ...
                <div class="ps-footnote">Al completar estos pasos recibirás un correo de <strong>{{ ENV('APP_NAME') }}</strong> confirmando tu pago.</div>
            </div>
        </div>
    </body>
</html>